...
function LinkedList:Append(List: LinkedList)
	if not LinkedList.Is(List) then
		error(
			string.format(INVALID_ARGUMENT_ERROR, 2, "LinkedList:Append", "LinkedList", Types.TypeOf(List)),
			2
		)
	end
...
function LinkedList:Prepend(List: LinkedList)
	if not LinkedList.Is(List) then
		error(
			string.format(INVALID_ARGUMENT_ERROR, 2, "LinkedList:Prepend", "LinkedList", Types.TypeOf(List)),
			2
		)
	end
